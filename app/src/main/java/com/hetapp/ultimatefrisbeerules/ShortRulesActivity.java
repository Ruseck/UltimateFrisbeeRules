 ...
 */
public class ShortRulesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Map m;
        String[]item=getResources().getStringArray(R.array.short_rules_title);
        String[]text=getResources().getStringArray(R.array.short_rules);
